...
* EPOMAKER K870T 87キー
  * これはネットで見たらコスパがいいと言われたので、買ったらよかった。テンキーレスの中でサイズも小さいし、Mac、Winモードもあり、RGBもちゃんとできてる
  * でもキースイッチがいいものではないこと、キーボードに全然ルブされてないことが残念だった。
  * でもルブしてみたかったから、吸音材（ただの紙だけど）とルブしてみたらある程度音は静かになった。 
* ~~EPOMAKER EP84 84キー返品予定~~
  * 悪くないけど、値段がVisslesと同じぐらいで、F1~12にあるFnKey（音調節など）がちゃんと動いてなかった。
* <b>Vissles V84 84キー</b> ~~A.K.A keychron Killer~~
  * これだ、これ最高だった。アマゾンで割引してたし、買おうとしてた「茶軸」の数量が少なかったので、買ってしまった。
  * 見た目はKeychronみたいな感じがするか、いったんボックスの内容が半端ない、腕置きも入ってたし、構成がよかった。
  * 決定的にルブもされてる。KeychronとEPOMAKERはルブはされてなかった。キー押した感じは全然違う。
  * そしてレビューではキースイッチがgateronではないと書いてたか、なんとgateronスイッチが入ってた！Amazonでもなんのスイッチかわからないって書いてたのに、、これはすごい
  * ８４キー＋割引してた値段＋完璧な商品の構成＋Mac・Win両方可能＋ルブされてる　これはいい！
  * https://talpkeyboard.net/items/5b9e0ff7ef843f7701000386　このスイッチで入れ替えて使ってる、不思議な感じのスイッチ

Keychronは失敗！

Visslesで決定！しばらくキーボードは買わない

あと他のキースイッチを使ってみたいと思って、お試しセットと、Gateron Silent茶軸を注文した！
